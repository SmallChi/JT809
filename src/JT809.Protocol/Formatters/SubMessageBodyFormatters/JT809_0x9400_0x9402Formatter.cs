...
namespace JT809.Protocol.Formatters.SubMessageBodyFormatters
{
    public class JT809_0x9400_0x9402Formatter : IJT809Formatter<JT809_0x9400_0x9402>
    {
        public JT809_0x9400_0x9402 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT809_0X9400_0X9402.WarnSrc = (JT809WarnSrc)JT809BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT809_0X9400_0X9402.WarnType = (JT809WarnType)JT809BinaryExtensions.ReadUInt16Little(bytes, ref offset);
